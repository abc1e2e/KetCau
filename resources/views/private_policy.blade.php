    ...
    <div class="private_bg_1">
        <div class="container ">
            <div class="about_header">
                <p class="p_bg_1">Chính sách bảo mật</p>
                <hr>
                <p class="p_bg_2"> Trang chủ <img src="img_about/arrow-drop-right-fill.png" alt="arrow-drop-right-fill"> Chính sách bảo mật </p>
            </div>
        </div>
    </div>
