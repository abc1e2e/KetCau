...
@section('content')
    <div class="container">
        <p class="p_new_1"> Trang chủ  <img src="../../images/arrow-right-double-sharp.png" alt="arrow-right-double-sharp">Sản phẩm <img src="../../images/arrow-right-double-sharp.png" alt="arrow-right-double-sharp"> Máy móc, thiết bị công nghiệp</p>
    </div>
